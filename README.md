...
Notes:
- Current ep3 may randomly stuck during execution due to its backend system (it consists of shell scripts that execute many `entr` as background processes). I am developing another backend named [medal](https://github.com/tom-tan/medal) and will replace current backend system with medal.
